  ...
  return (
    <div className="card relative overflow-hidden my-4">
      ...
      <div className="flex flex-col lg:flex-row inner-card my-6">
        <div className="my-2 w-full lg:w-2/5">
          <div className="mb-3">
        ...
        <div className="my-2 w-full lg:w-3/5">
          <div className="mb-2">
            <p className="text-md font-semibold font-sans text-gray">
              Reciptant address
            </p>
            <p className="text-sm font-bold font-sans text-gray-600 w-80 truncate ">
              {props.reciptant}
            </p>
          </div>
